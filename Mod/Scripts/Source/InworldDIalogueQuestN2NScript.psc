    ...
    While true
       int _time = Utility.GetCurrentRealTime() as int
        ...
        If N2N_ConversationOnGoing != None && N2N_ConversationOnGoing.GetValueInt() == 0
		    ...
		    Debug.Trace("Inworld: Target Actor = " + targetActor.GetDisplayName())                    
...
bool function IsVoiceIncluded(Actor _actor) 
    return _InworldVoiceTypes != None && _InworldVoiceTypes.GetAt(0) != None && _InworldVoiceTypes.GetAt(1) != None &&  _actor.GetVoiceType() != None && ((_InworldVoiceTypes.GetAt(0) as FormList).HasForm(_actor.GetVoiceType()) || (_InworldVoiceTypes.GetAt(1) as FormList).HasForm(_actor.GetVoiceType())) &&  !_InworldVoiceTypes_Exclude.HasForm(_actor.GetVoiceType())
endFunction
