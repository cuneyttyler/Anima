...
export default class PromptManager {
    ...
    BroadcastPrompt(speaker, listener, message, currentDateTime, closest) {
        return "THIS IS A BROADCAST MESSAGE (NOT SPECIFICALLY SPOKEN TO YOU). \n" 
            ...
            + "DO NOT ANSWER IF SPEAKER ADDRESSES A DIFFERENT PERSON (e.g USING HIS/HER NAME) \n"
            ...
            + "SOMETIMES YOU TALK TOO MUCH AND REPEAT YOURSELF. DON'T DO THAT. JUST DON'T SPEAK AND RESPONSE **NOT_ANSWERING** IF THERE'S ENOUGH TALK ALREADY. \n"
            + "SOMETIMES YOU TALK TOO MUCH AND REPEAT YOURSELF. DON'T DO THAT. JUST DON'T SPEAK AND RESPONSE **NOT_ANSWERING** IF THERE'S ENOUGH TALK ALREADY. \n"
            + "SOMETIMES YOU TALK TOO MUCH AND REPEAT YOURSELF. DON'T DO THAT. JUST DON'T SPEAK AND RESPONSE **NOT_ANSWERING** IF THERE'S ENOUGH TALK ALREADY. \n"
            + "SOMETIMES YOU TALK TOO MUCH AND REPEAT YOURSELF. DON'T DO THAT. JUST DON'T SPEAK AND RESPONSE **NOT_ANSWERING** IF THERE'S ENOUGH TALK ALREADY. \n"
            + "SOMETIMES YOU TALK TOO MUCH AND REPEAT YOURSELF. DON'T DO THAT. JUST DON'T SPEAK AND RESPONSE **NOT_ANSWERING** IF THERE'S ENOUGH TALK ALREADY. \n"
